...
class FlightAirportMovementContract {
  /// Returns a new [FlightAirportMovementContract] instance.
  ...
  bool operator ==(Object other) =>
      ...
      other is FlightAirportMovementContract &&
  ...
  @override
  String toString() =>
      'FlightAirportMovementContract[airport=$airport, quality=$quality, scheduledTime=$scheduledTime, revisedTime=$revisedTime, runwayTime=$runwayTime, terminal=$terminal, checkInDesk=$checkInDesk, gate=$gate, baggageBelt=$baggageBelt, runway=$runway]';
  ...
  static FlightAirportMovementContract? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "FlightAirportMovementContract[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "FlightAirportMovementContract[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return FlightAirportMovementContract(
  ...
  static List<FlightAirportMovementContract> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    final result = <FlightAirportMovementContract>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = FlightAirportMovementContract.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, FlightAirportMovementContract> mapFromJson(dynamic json) {
    final map = <String, FlightAirportMovementContract>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = FlightAirportMovementContract.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of FlightAirportMovementContract-objects as value to a dart map
  static Map<String, List<FlightAirportMovementContract>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    final map = <String, List<FlightAirportMovementContract>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = FlightAirportMovementContract.listFromJson(
          entry.value,
          growable: growable,
        );
      }
